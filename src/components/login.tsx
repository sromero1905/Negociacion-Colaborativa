...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${BACK_URL}/api/user-elearnings/login`, {
        method: 'POST',
        headers: {
  ...
  const handleRequestResetToken = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${BACK_URL}/api/user-elearnings/forgot-password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleResetPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${BACK_URL}/api/user-elearnings/reset-password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
